...
public class RuleActionEntity <T extends RuleActionEntity.GachaEntity>{
    ...
    private String code= RuleActionVO.ALLOW.getCode();
    private String info= RuleActionVO.ALLOW.getInfo();
    ...
    @NoArgsConstructor
    @Builder
    static public class ProcessingGachaEntity extends RuleActionEntity.GachaEntity {
        // 用于抽奖的策略 id
        private Long strategyId;
        // 返回的其他随机奖品 id
        private Integer awardId;
