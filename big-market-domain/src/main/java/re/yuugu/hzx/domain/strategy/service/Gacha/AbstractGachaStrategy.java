...
public abstract class AbstractGachaStrategy implements IGachaStrategy {
    ...
    public GachaAwardEntity performGacha(GachaFactorEntity gachaFactor) {
        ...
        if (RuleActionVO.TAKE_OVER.getCode().equals(ruleActionEntity.getCode())) {
            log.info("匹配到规则");
            ...
            gachaAwardId = strategyArmory.getRandomAwardId(String.valueOf(strategyId));
        }
